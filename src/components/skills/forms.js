...
export const aboutMeBio = (
  <div>
    <h1 style={bold}>UMMER ZAMAN</h1>
    <p style={text}>
      A React JS and .Net developer who has passion for coding. Currently I work
      as a Junior Software Engineer at UnTribe working on GrandStack. I am
      highly skilled in React as I use it for front end and Redux or Apollo as
...
export const textForm = (
  <div>
    <h1 style={bold}>TECHNICAL SKILLS! </h1>
    <p style={h2}>
      I am a Strong believer of <span style={head}>Hard Work</span> <br />
      I am always passionate about learing new languages where they are related
      to current project or not.
      <br />
      <span style={head}>Here are few of the ones I have learned so far</span>
      <br />
      & <br />
      Please click on the thumbnails to read the skill set I have for that
      language
    </p>
  </div>
)
export const projectTextForm = (
  <div>
    <h1 style={bold}>PERSONAL PROJECTS! </h1>
    <p style={h2}>
      ...
      <br />
      & <br />
      Please click on the thumbnails to read details
    </p>
  </div>
)
